...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden bg-white border-b border-gray-200 px-3 sm:px-4 py-2.5 sm:py-3 flex items-center justify-between fixed top-0 left-0 right-0 z-50">
      ...
      {/* Overlay for mobile - Behind sidebar but above content */}
      {sidebarOpen && (
        <div
      ...
      `}>
        ...
        <div className="hidden lg:flex h-16 px-4 sm:px-6 items-center border-b border-gray-200 flex-shrink-0">
          <h1 className="text-xl sm:text-2xl font-bold text-primary-600">Devang Lights</h1>
        </div>
        
        {/* Mobile Logo in sidebar */}
        <div className="lg:hidden h-16 px-4 flex items-center border-b border-gray-200 flex-shrink-0">
          <h1 className="text-xl font-bold text-primary-600">Devang Lights</h1>
        </div>
